...
This document explains how you can write a transient/persistent custom serilaizer that works with Ehcache.
Here we discuss the significance of transient serializers and persistent serializers in detail and what they actually 
mean.
...
What would have happened if we had proceeded with the sample code? Would it have failed? If yes, then where?
